...
const createSandbox = (
  ...
  const sandbox = {
     ...
     *
     * Kept separate from scenario validation.
     */
    actions: [],

    /*
     * Raw stdout captured from this session's
...
const resetSandbox = (sessionId) => {
  ...
  /*
   * Previously captured setup output is stale
   * until the new setup.sh run completes.
   */
  sandbox.setupOutput = "";
